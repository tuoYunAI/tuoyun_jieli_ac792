...
#pragma bss_seg(".chorus_demo.data.bss")
#pragma data_seg(".chorus_demo.data")
#pragma const_seg(".chorus_demo.text.const")
#pragma code_seg(".chorus_demo.text")
#endif
...
void user_chorus_udpate_parm_demo()
{
    ...
    char *node_name       = "chorus_name"; //节点名称（节点内的第一参数，用户自定义,长度小于等于15byte）
