...
#pragma bss_seg(".stereo_widener_demo.data.bss")
#pragma data_seg(".stereo_widener_demo.data")
#pragma const_seg(".stereo_widener_demo.text.const")
#pragma code_seg(".stereo_widener_demo.text")
#endif
...
void user_stereo_widener_udpate_parm_demo()
{
    ...
    char *node_name       = "widener_name";     //节点名称（节点内的第一参数，用户自定义,长度小于等于15byte）
