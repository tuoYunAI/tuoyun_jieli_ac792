...
#pragma bss_seg(".reverb_demo.data.bss")
#pragma data_seg(".reverb_demo.data")
#pragma const_seg(".reverb_demo.text.const")
#pragma code_seg(".reverb_demo.text")
#endif
...
void user_reverb_udpate_parm_demo()
{
