...
#pragma bss_seg(".noisegate_demo.data.bss")
#pragma data_seg(".noisegate_demo.data")
#pragma const_seg(".noisegate_demo.text.const")
#pragma code_seg(".noisegate_demo.text")
#endif
