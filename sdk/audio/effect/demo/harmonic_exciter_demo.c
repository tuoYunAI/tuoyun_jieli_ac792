...
#pragma bss_seg(".harmonic_exciter_demo.data.bss")
#pragma data_seg(".harmonic_exciter_demo.data")
#pragma const_seg(".harmonic_exciter_demo.text.const")
#pragma code_seg(".harmonic_exciter_demo.text")
#endif
...
void user_harmonic_exciter_udpate_parm_demo()
{
    ...
    char *node_name       = "excitor_name";  //节点名称（节点内的第一参数，用户自定义,长度小于等于15byte）
