...
#pragma bss_seg(".echo_demo.data.bss")
#pragma data_seg(".echo_demo.data")
#pragma const_seg(".echo_demo.text.const")
#pragma code_seg(".echo_demo.text")
#endif
...
void user_echo_udpate_parm_demo()
{
    ...
    char *node_name       = "echo_name";     //节点名称（节点内的第一参数，用户自定义,长度小于等于15byte）
