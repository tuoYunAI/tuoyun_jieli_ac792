...
#pragma bss_seg(".notch_howling_demo.data.bss")
#pragma data_seg(".notch_howling_demo.data")
#pragma const_seg(".notch_howling_demo.text.const")
#pragma code_seg(".notch_howling_demo.text")
#endif
...
void user_howling_suppress_udpate_parm_demo()
{
    ...
    char *node_name       = "notch_name";     //节点名称（节点内的第一参数，用户自定义,长度小于等于15byte）
