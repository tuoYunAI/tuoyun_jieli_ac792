...
static void h63p_awb_post_process(u32 prob, u32 ev, u32 zone_type, u16 *r_gain, u16 *b_gain, void *data)
{
...
static isp_awb_ct2_params_t awb_ct2_params = {
    .awb_post_process = h63p_awb_post_process,
...
static isp_awb_params_t H63P_MIPI_awb_params = {
...
void *H63P_MIPI_get_awb_params()
{
    return (void *)&H63P_MIPI_awb_params;
}
