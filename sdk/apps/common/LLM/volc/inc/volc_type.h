...
// #define VOLC_DEBUG_ENABLE

#ifdef VOLC_DEBUG_ENABLE
#define volc_debug(format, ...)      printf(format, ## __VA_ARGS__)
#define volc_debug_hexdump(x, y)     printf_buf(x, y)
#else
#define volc_debug(...)
#define volc_debug_hexdump(x, y)
#endif
