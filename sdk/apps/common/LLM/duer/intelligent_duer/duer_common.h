...
#define INTELLIGENT_DUER	1
#define DUER_CLIENT_AK				"xxxxxxxxxxxxxxxxxxxxxxxxx"
#define DUER_CLIENT_SK				"xxxxxxxx"
#define DUER_APP_PID					"xxxxx"
#define DUER_APP_CUID					"xxxx"
// #define DUER_APP_FORMAT				"text"
