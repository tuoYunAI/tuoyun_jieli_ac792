...
int gatt_send_set_rsp(uint16_t tid, uint8_t nums, properties_t *newProps);
int gatt_send_get_rsp(uint16_t tid, uint8_t nums, properties_t *newProps);
int gatt_send_action_rsp(uint16_t tid, int16_t code, arguments_t *out_args);
...
mible_status_t mible_gatt_spec_mcmd_init(spec_data_parse_callback_t set_cb,
        spec_data_parse_callback_t get_cb,
        spec_data_parse_callback_t action_cb,
        uint16_t buflen, uint16_t queue_size);
