 ...
 */
#define FIRMWARE_TYPE         "xunyou_jieli_7923AE_firmware"            
...
/**
 * 自研的方盒产品的flash没有UUID, 以下手动定义这个UUID
 * 前10个字符为电路板上的批号，根据实际情况修改，后32个字符为固定值"FFFFFF0E0900040108FF15"，这个值由平台提供，不要修改，否则设备将无法通过认证
 */
#define FLASH_UUID      "2601260001""FFFFFF0E0900040108FF15" 
