...
#define PRODUCT_TYPE          "JIELI7926F_PRODUCT_DEV"        //产品的类型, 需要在平台上注册*
#define PRODUCT_NAME          "TUOYUN_ROBOT"                  //产品名称

#define BOARD_TYPE            "JIELI7926F_DEV"                //控制板的类型, 由平台提供*
#define BOARD_NAME            "jieli-ai-dev"                  //控制板的名称, 由平台提供


#define FIRMWARE_TYPE         "TY_JIELI7926F_DEV"             //固件的类型, 由平台提供*
