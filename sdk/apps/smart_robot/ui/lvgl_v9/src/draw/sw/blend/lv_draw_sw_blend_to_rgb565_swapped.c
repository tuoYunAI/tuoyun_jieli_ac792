        ...
        for (y = 0; y < h; y++) {
            ...
            for (x = 0; x < w; x++) {
                ...
                if (mask_buf == NULL) {
                    ...
                    if (opa >= LV_OPA_MAX) {
                        dest_buf_u16[x] = lv_color_swap_16(lv_color_16_16_mix(res, dest_buf_u16[x], mask_buf[x]));
                    } else {
                        dest_buf_u16[x] = lv_color_swap_16(lv_color_16_16_mix(res, dest_buf_u16[x], LV_OPA_MIX2(mask_buf[x], opa)));
                    }
                }
            }
