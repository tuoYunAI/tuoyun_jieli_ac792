...
lv_state_t lv_xml_state_to_enum(const char *txt)
{
    ...
    if (lv_streq("hovered", txt)) {
        return LV_STATE_HOVERED;
    }
    if (lv_streq("scrolled", txt)) {
    ...
    if (lv_streq("focus_key", txt)) {
        return LV_STATE_FOCUS_KEY;
    }
    if (lv_streq("edited", txt)) {
...
{
    if (lv_streq("top_left", txt)) {
        return LV_ALIGN_TOP_LEFT;
    }
    if (lv_streq("top_mid", txt)) {
        return LV_ALIGN_TOP_MID;
    }
    if (lv_streq("top_right", txt)) {
        return LV_ALIGN_TOP_RIGHT;
    }
    if (lv_streq("bottom_left", txt)) {
        return LV_ALIGN_BOTTOM_LEFT;
    }
    if (lv_streq("bottom_mid", txt)) {
        return LV_ALIGN_BOTTOM_MID;
    }
    if (lv_streq("bottom_right", txt)) {
        return LV_ALIGN_BOTTOM_RIGHT;
    }
    if (lv_streq("right_mid", txt)) {
        return LV_ALIGN_RIGHT_MID;
    }
    if (lv_streq("left_mid", txt)) {
        return LV_ALIGN_LEFT_MID;
    }
    if (lv_streq("center", txt)) {
...
lv_dir_t lv_xml_dir_to_enum(const char *txt)
{
    ...
    if (lv_streq("bottom", txt)) {
        return LV_DIR_BOTTOM;
    }
    if (lv_streq("left", txt)) {
        return LV_DIR_LEFT;
    }
    if (lv_streq("right", txt)) {
        return LV_DIR_RIGHT;
    }
    if (lv_streq("hor", txt)) {
        return LV_DIR_HOR;
...
lv_border_side_t lv_xml_border_side_to_enum(const char *txt)
{
    ...
    if (lv_streq("top", txt)) {
        return LV_BORDER_SIDE_TOP;
    }
    if (lv_streq("bottom", txt)) {
        return LV_BORDER_SIDE_BOTTOM;
    }
    if (lv_streq("left", txt)) {
        return LV_BORDER_SIDE_LEFT;
    }
    if (lv_streq("right", txt)) {
        return LV_BORDER_SIDE_RIGHT;
    }
    if (lv_streq("full", txt)) {
...
lv_text_decor_t lv_xml_text_decor_to_enum(const char *txt)
{
    ...
    if (lv_streq("underline", txt)) {
        return LV_TEXT_DECOR_UNDERLINE;
    }
    if (lv_streq("strikethrough", txt)) {
...
lv_flex_align_t lv_xml_flex_align_to_enum(const char *txt)
{
    ...
    if (lv_streq("start", txt)) {
        return LV_FLEX_ALIGN_START;
    }
    if (lv_streq("space_around", txt)) {
        return LV_FLEX_ALIGN_SPACE_AROUND;
    }
    if (lv_streq("space_between", txt)) {
        return LV_FLEX_ALIGN_SPACE_BETWEEN;
    }
    if (lv_streq("space_evenly", txt)) {
...
lv_layout_t lv_xml_layout_to_enum(const char *txt)
{
    ...
    if (lv_streq("flex", txt)) {
        return LV_LAYOUT_FLEX;
    }
    if (lv_streq("grid", txt)) {
...
{
    if (lv_streq("normal", txt)) {
        return LV_BLEND_MODE_NORMAL;
    }
    if (lv_streq("additive", txt)) {
        return LV_BLEND_MODE_ADDITIVE;
    }
    if (lv_streq("subtractive", txt)) {
        return LV_BLEND_MODE_SUBTRACTIVE;
    }
    if (lv_streq("multiply", txt)) {
        return LV_BLEND_MODE_MULTIPLY;
    }
    if (lv_streq("difference", txt)) {
        return LV_BLEND_MODE_DIFFERENCE;
    }
